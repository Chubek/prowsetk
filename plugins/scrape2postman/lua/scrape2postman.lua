...
function M.render_postman_json(endpoints, spec)
    ...
    return '{"info":{"name":' .. quote(spec.collection_name or "Discovered API (scrape2postman)")
        ...
        .. '"description":"Generated by ProwseTk scrape2postman. Heuristic API discoveries; '
        .. 'not authoritative documentation. Request bodies and credentials are omitted."},"item":['
        .. table.concat(items, ",") .. ']}\n'
end
